...
function setup() {
  ...
  kangroo = createSprite(50,200,20,50)
  kangroo.addAnimation("running",kangaroo_running)
  kangroo.addAnimation("collided",kangroo_collided)
  kangroo.scale = 0.15
  kangroo.setCollider("circle",0,0,300)
  invisibleGround= createSprite(400,1600,350,30)
